...
const SectionHeaderWithLines = ({
  ...
  return (
    <div className={cn("flex flex-col items-center gap-2 w-full", className)}>
      <div className="flex items-center gap-3 sm:gap-5 lg:gap-8 w-full">
      ...
      {subtitle && (
        <p className="text-sm sm:text-base lg:text-lg font-medium leading-6 sm:leading-7 text-[#637381] text-center max-w-185">
          {subtitle}
        </p>
      )}
    </div>
