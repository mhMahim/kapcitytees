        ...
        <div className="flex flex-col lg:flex-row items-start gap-0">
          ...
          <div className="flex flex-col gap-6 py-8 flex-1 max-w-171.75">
            ...
            <p className="text-lg font-normal leading-8 text-[#3F5563] opacity-80">
              Our products are developed and approved by professional barbers who
              know men&apos;s grooming best. Every formula is tested in real
          ...
          <div className="relative w-full lg:w-151.25 h-120 shrink-0">
            {/* Main center image */}
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-106 h-115.5 rounded-[32px] overflow-hidden">
              <Image
                src={BARBER_MAIN}
                alt="Barber at work"
                fill
            ...
            {/* Small left image */}
            <div className="absolute left-0 bottom-0 w-42.25 h-60.75 rounded-2xl overflow-hidden">
              <Image
                src={BARBER_SMALL_1}
                alt="Grooming detail"
                fill
            ...
            {/* Small right image */}
            <div className="absolute right-0 top-0 w-42.25 h-60.75 rounded-2xl overflow-hidden">
              <Image
                src={BARBER_SMALL_2}
                alt="Barber tools"
                fill
