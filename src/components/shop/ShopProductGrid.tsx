...
const ShopProductGrid = ({
  ...
  return (
    <div className="flex flex-col gap-6 w-full">
      {/* Header row */}
      <div className="flex items-center lg:items-start justify-between gap-3 w-full">
        <div className="flex items-center gap-2 sm:gap-4 lg:gap-6 min-w-0">
          <h2 className="text-base sm:text-xl lg:text-2xl font-semibold text-[#0F2A3C] leading-tight sm:leading-9 shrink-0">
            Products
          </h2>
        ...
        <div className="relative shrink-0">
          ...
          >
            <span className="text-sm font-medium text-[#0F2A3C]">
              {selectedSortLabel}
            </span>
